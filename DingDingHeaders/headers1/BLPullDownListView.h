...
@protocol BLPullDownListViewDataSource, BLPullDownListViewDelegate;

@interface BLPullDownListView : UIView <UITableViewDataSource, UITableViewDelegate>
{
    _Bool _isShowing;
    _Bool _isAnimating;
    ...
    id <BLPullDownListViewDelegate> _delegate;
    id <BLPullDownListViewDataSource> _dataSource;
    double _rowHeight;
}

@property(nonatomic) _Bool isAnimating; // @synthesize isAnimating=_isAnimating;
@property(nonatomic) double rowHeight; // @synthesize rowHeight=_rowHeight;
@property(nonatomic) __weak id <BLPullDownListViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
@property(nonatomic) __weak id <BLPullDownListViewDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)changeTableViewHeight:(double)arg1 animated:(_Bool)arg2;
