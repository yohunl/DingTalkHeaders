...
@class NSDate, NSString, NSTimer, UIColor, UIFont, UILabel, UITapGestureRecognizer;
...
+ (void)showNotice:(id)arg1 duration:(float)arg2;
+ (void)showAboveKeyBoardNotice:(id)arg1;
+ (void)showKeyWindowNotice:(id)arg1;
...
- (void)tapOneGestureAction:(id)arg1;
- (void)addClickHide;
- (id)showtitleNotic:(id)arg1 time:(double)arg2;
- (void)hiddenNotic;
- (void)showNotic;
- (void)hideDelayedview:(id)arg1;
- (void)showtitleNoticatup:(id)arg1 inView:(id)arg2;
- (void)showtitleNoticatup:(id)arg1;
- (void)showtitleNoticTwoSec:(id)arg1;
- (void)showtitleNotic:(id)arg1;
