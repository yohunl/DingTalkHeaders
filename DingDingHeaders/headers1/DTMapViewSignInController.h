...
@class AMapPOI, AMapSearchAPI, CLLocation, DTMapViewNoSearchResultHolderUIView, DTSearchBar, DTTableView, MAMapView, NSError, NSMutableArray, NSString, UIButton, UISearchDisplayController;
@protocol DTMapViewSignInControllerDelegate;

@interface DTMapViewSignInController : DTViewController <MAMapViewDelegate, AMapSearchDelegate, UISearchDisplayDelegate, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate>
{
    MAMapView *_mapView;
    ...
    id <DTMapViewSignInControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <DTMapViewSignInControllerDelegate> delegate; // @synthesize delegate=_delegate;
