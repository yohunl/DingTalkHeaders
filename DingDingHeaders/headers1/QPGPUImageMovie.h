...
@class AVAsset, AVAssetReader, AVPlayerItem, AVPlayerItemVideoOutput, CADisplayLink, NSString, NSURL, QPGLProgram, QPGPUImageMovieWriter;
@protocol GPUImageMovieDelegate;

@interface QPGPUImageMovie : QPGPUImageOutput <AVPlayerItemOutputPullDelegate>
{
