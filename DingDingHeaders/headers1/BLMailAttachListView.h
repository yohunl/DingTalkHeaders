...
@protocol BLMailAttachListViewDelegate;

@interface BLMailAttachListView : UIView <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
    _Bool _isEditable;
    _Bool _showTopSeperatorLine;
    _Bool _layoutInitialized;
    id <BLMailAttachListViewDelegate> _delegate;
...
@property(nonatomic) __weak id <BLMailAttachListViewDelegate> delegate; // @synthesize delegate=_delegate;
