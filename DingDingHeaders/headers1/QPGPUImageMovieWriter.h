...
@class AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, NSArray, NSString, NSURL, QPGLProgram;
@protocol GPUImageTextureDelegate, QPGPUImageMovieWriterDelegate;

@interface QPGPUImageMovieWriter : NSObject <GPUImageInput>
{
    ...
    QPGLProgram *colorSwizzlingProgram;
    ...
    id <QPGPUImageMovieWriterDelegate> _delegate;
...
@property(nonatomic) id <QPGPUImageMovieWriterDelegate> delegate; // @synthesize delegate=_delegate;
