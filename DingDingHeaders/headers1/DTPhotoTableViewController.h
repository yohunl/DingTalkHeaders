...
@class DTImageView, DTLoadMoreController, DTPhotoBrowerHelper, NSArray, NSString, UITableView, UIView, UIViewController;
...
- (void).cxx_destruct;
- (id)thumbImageForItem:(id)arg1 atIndex:(long long)arg2;
