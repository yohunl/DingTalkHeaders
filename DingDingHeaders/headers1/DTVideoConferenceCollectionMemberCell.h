...
@property(nonatomic) id <DTVideoConferenceCollectionMemberCellDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) id <DTVideoConferenceCollectionMemberCellDataSource> dataSource; // @synthesize dataSource=_dataSource;
