...
#import "BLAttachmentInterface-Protocol.h"
...
@class BLAttachment, BLMailAttachmentPresenter, BLPreviewItem, BLProgressView, NSString, NSURL, QLPreviewController, UIButton, UIDocumentInteractionController, UIImageView, UILabel;
@protocol BLFileBasedInterfaceRouteDelegate;

@interface BLMailAttachmentViewController : BLViewController <QLPreviewControllerDataSource, QLPreviewControllerDelegate, UIActionSheetDelegate, UIDocumentInteractionControllerDelegate, BLAttachmentInterface>
{
    BLMailAttachmentPresenter *_attachmentModule;
...
@property(retain, nonatomic) BLMailAttachmentPresenter *attachmentModule; // @synthesize attachmentModule=_attachmentModule;
- (void).cxx_destruct;
