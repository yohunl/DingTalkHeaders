...
@class DTAttributedLabel, DTBizDingAttachmentExtra, DTBizDingLinkModel, DTBizDingModel, DTContact, DTDingTableViewCell, NSString, NSURL, UITapGestureRecognizer;
...
- (void)moreOperation:(DTBizDingModel *)arg1 cell:(DTDingTableViewCell *)arg2;
...
- (void)needOpenDingComment:(DTBizDingModel *)arg1 cell:(DTDingTableViewCell *)arg2;
