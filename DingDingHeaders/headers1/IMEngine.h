...
@class NSString, OfflineSyncRequestFilter, OpenDatabase, OpenGCDQueue, WKSyncProtocolHandler;
...
@interface IMEngine : NSObject <WKOAuthServiceDelegate, WKAuthProtocol>
{
    ...
    WKSyncProtocolHandler *_syncProtocolHandler;
}
...
+ (id)sharedIMEngine;
@property(readonly, nonatomic) WKSyncProtocolHandler *syncProtocolHandler; // @synthesize syncProtocolHandler=_syncProtocolHandler;
