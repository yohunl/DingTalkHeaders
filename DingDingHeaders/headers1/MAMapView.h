...
@class CLLocationManager, MAAnnotationContainerView, MAAnnotationManager, MAAnnotationView, MACompassView, MADataCache, MADataSourceContainer, MAMapScrollView, MAOverlayContainerView, MAScaleView, MATrafficSource, MAUserLocation, NSArray, NSOperationQueue, NSString, UIImageView, UILongPressGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
@interface MAMapView : UIView <UIScrollViewDelegate, UIGestureRecognizerDelegate, CLLocationManagerDelegate, MAMapScrollViewDelegate, MAOverlayContainerViewDelegate, MAAnnotationManagerDelegate, MAAnnotationContainerDelegate, MAAnnotationContainerViewDelegate, MACompassViewDelegate>
{
    ...
    CDStruct_02837cd9 _limitMapRect;
}

@property(retain, nonatomic) MADataCache *dataCache; // @synthesize dataCache=_dataCache;
@property(nonatomic) CDStruct_90e2a262 limitMapRect; // @synthesize limitMapRect=_limitMapRect;
...
- (double)zoomScaleCoverMapRect:(CDStruct_90e2a262)arg1 edgePadding:(struct UIEdgeInsets)arg2;
...
@property(nonatomic) CDStruct_90e2a262 limitRegion;
