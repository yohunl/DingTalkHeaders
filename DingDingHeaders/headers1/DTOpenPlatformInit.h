...
@interface DTOpenPlatformInit : NSObject <DTCheckInTaskManagerDelegate>
{
}
...
- (void)taskManager:(id)arg1 handleSrcType:(long long)arg2;
- (void)taskManager:(id)arg1 handleWarning:(id)arg2;
