...
@class BLFolder, DTIMAPAccount, DTIMAPFetchInfosQueue, NSArray, NSMutableArray;

@interface DTIMAPRefreshMailTask : BLBaseAPITask
{
    BLFolder *_folder;
    NSArray *_folders;
    ...
    DTIMAPFetchInfosQueue *_infosQueue;
}

@property(retain, nonatomic) DTIMAPFetchInfosQueue *infosQueue; // @synthesize infosQueue=_infosQueue;
